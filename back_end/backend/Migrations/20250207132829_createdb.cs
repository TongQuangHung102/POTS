    ...
    public partial class createdb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompetitionResults", x => new { x.UserId, x.ContestId });
                    table.ForeignKey(
                        name: "FK_CompetitionResults_Contests_ContestId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ContestParticipantId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ContestId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContestParticipants", x => x.ContestParticipantId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserParentStudentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserParentStudent", x => new { x.StudentId, x.ParentId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateByAI = table.Column<bool>(type: "bit", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LessonId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AIQuestions_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "LessonId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AIQuestions_Levels_LevelId",
                        column: x => x.LevelId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<int>(type: "int", nullable: false),
                    LessonId = table.Column<int>(type: "int", nullable: false),
                    avg_Accuracy = table.Column<double>(type: "float", nullable: true),
                    avg_Time_Per_Question = table.Column<TimeSpan>(type: "time", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentPerformances", x => new { x.UserId, x.LessonId });
                    table.ForeignKey(
                        name: "FK_StudentPerformances_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "LessonId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentPerformances_Levels_LevelId",
                        column: x => x.LevelId,
                        principalTable: "Levels",
                        principalColumn: "LevelId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentPerformances_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentProgresses", x => new { x.UserId, x.LessonId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionId = table.Column<int>(type: "int", nullable: false),
                    QuestionAiId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnswerQuestions", x => x.AnswerQuestionId);
                    table.ForeignKey(
                        name: "FK_AnswerQuestions_AIQuestions_QuestionAiId",
                        column: x => x.QuestionAiId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContestQuestions", x => x.ContestQuestionId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AIQuestions_LessonId",
                table: "AIQuestions",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_AIQuestions_LevelId",
                table: "AIQuestions",
                column: "LevelId");

            migrationBuilder.CreateIndex(
                name: "IX_AnswerQuestions_QuestionAiId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompetitionResults_ContestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentPerformances_LessonId",
                table: "StudentPerformances",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentPerformances_LevelId",
                table: "StudentPerformances",
                column: "LevelId");
